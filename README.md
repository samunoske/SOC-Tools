...
| [Phish.Report](https://phish.report/) | Open-source phishing investigation tool. | `phishing` · `osint` | ✅ Free |
...
| Tool | Description | Tags | Access |
| :--- | :--- | :--- | :--- |
| [PacketTotal](https://www.packettotal.com/) | Free online PCAP analysis with extracted artifacts. | `pcap` · `analysis` | ✅ Free |
...
**87 tools** · **13 categories** · 21 with limited/free-tier access
